...
export class Backend implements backendInterface {
    ...
    async addPortfolioItem(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Time): Promise<void> {
    ...
    async getAllPageContent(): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
    ...
    async getPageContent(arg0: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async updatePageContent(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
